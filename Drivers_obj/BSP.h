...
#define BSP_BUTTON_UP ((PORT_1 | GPIO_PIN_VALID | GPIO_PIN_IRQ | GPIO_IRQ_EDGE_H_TO_L) | GPIO_PIN6)
#define BSP_BUTTON_DOWN ((PORT_1 | GPIO_PIN_VALID | GPIO_PIN_IRQ | GPIO_IRQ_EDGE_H_TO_L) | GPIO_PIN7)
